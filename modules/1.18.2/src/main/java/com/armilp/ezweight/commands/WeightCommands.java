                ...
                Commands.literal("ezweight")
                        ...
                        .then(Commands.literal("gui")
                                .executes(context -> {
                                    ...
                                    src.sendSuccess(new TranslatableComponent("message.ezweight.gui_open"), true);
                        ...
                        .then(Commands.literal("toggle")
                                .then(Commands.argument("player", StringArgumentType.word())
                                        .executes(context -> {
                                            ...
                                            if (player == null) {
                                                src.sendFailure(new TranslatableComponent("message.ezweight.player_not_found", playerName));
                                                return 0;
                                            }
                                            ...
                                            if (disabledPlayers.contains(uuid)) {
                                                ...
                                                src.sendSuccess(new TranslatableComponent("message.ezweight.toggle_enabled", playerName), true);
                                            } else {
                                                disabledPlayers.add(uuid);
                                                src.sendSuccess(new TranslatableComponent("message.ezweight.toggle_disabled", playerName), true);
                                            }
                                            return Command.SINGLE_SUCCESS;
                                        })
                                )
                        ...
                        .then(Commands.literal("toggleall")
                                .executes(context -> {
                                    ...
                                    src.sendSuccess(new TranslatableComponent(allDisabled ?
                        ...
                        .then(Commands.literal("info")
                                .then(Commands.argument("player", StringArgumentType.word())
                                        .executes(context -> {
                                            ...
                                            src.sendSuccess(new TranslatableComponent("message.ezweight.player_info",
                                                    playerName,
