        ...
        try {
            ...
            for (JsonElement element : jsonLevels) {
                ...
                for (JsonElement effElement : effs) {
                    ...
                    MobEffect effect = ForgeRegistries.MOB_EFFECTS.getValue(new ResourceLocation(effObj.get("effect").getAsString()));
    ...
    public static String toJsonString(List<WeightLevel> levels) {
        ...
        for (WeightLevel level : levels) {
            ...
            for (MobEffectInstance eff : level.effects()) {
                ...
                effObj.addProperty("effect", ForgeRegistries.MOB_EFFECTS.getKey(eff.getEffect()).toString());
