...
public class MultiWeightEditScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(
                ...
                Component.translatable("gui.ezweight.save"),
                b -> {
                    try {
        ...
        this.addRenderableWidget(new Button(
                ...
                Component.translatable("gui.ezweight.cancel"),
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        drawCenteredString(poseStack, this.font, Component.translatable("screen.ezweight.edit_multiple"), this.width / 2, this.height / 2 - 30, 0xFFFFFF);
