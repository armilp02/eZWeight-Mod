...
public class WeightMiniHudOverlay {
    ...
    public static void onRender(RenderGuiOverlayEvent.Post event) {
        ...
        renderIcon(poseStack, icon, x, y, iconSize, scale, alpha);
    }
    ...
    private static void renderIcon(PoseStack poseStack, ResourceLocation icon, int x, int y, int size, float scale, float alpha) {
        ...
        Screen.blit(poseStack, 0, 0, 0, 0, size, size, size, size);
