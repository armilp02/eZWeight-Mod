...
public class WeightConfigScreen extends Screen {
    ...
    public WeightConfigScreen(Screen parent) {
        super(new TextComponent("ᴇᴢᴡᴇɪɢʜᴛ ʜᴜᴅ"));
        this.parent = parent;
    }
...
class MainHudConfigScreen extends Screen {
    ...
    protected MainHudConfigScreen(Screen parent) {
        super(new TextComponent("Main HUD Settings"));
        this.parent = parent;
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new Button(
                centerX - buttonWidth / 2, anchorButtonY, buttonWidth, buttonHeight,
                        new TextComponent("Anchor: " + currentAnchor.name()),
                        btn -> {
                            ...
                            btn.setMessage(new TextComponent("Anchor: " + currentAnchor.name()));
                        })
        );

        offsetXBox = new net.minecraft.client.gui.components.EditBox(this.font, leftCol, offsetBoxesY, editBoxWidth, buttonHeight, new TextComponent("Offset X"));
        ...
        offsetYBox = new net.minecraft.client.gui.components.EditBox(this.font, rightCol, offsetBoxesY, editBoxWidth, buttonHeight, new TextComponent("Offset Y"));
...
class MiniHudConfigScreen extends Screen {
    ...
    protected MiniHudConfigScreen(Screen parent) {
        super(new TextComponent("Mini HUD Settings"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        miniXBox = new net.minecraft.client.gui.components.EditBox(this.font, leftCol, posBoxesY, editBoxWidth, buttonHeight, new TextComponent("Mini X"));
        ...
        miniYBox = new net.minecraft.client.gui.components.EditBox(this.font, rightCol, posBoxesY, editBoxWidth, buttonHeight, new TextComponent("Mini Y"));
        ...
        miniSizeBox = new net.minecraft.client.gui.components.EditBox(this.font, centerX - editBoxWidth / 2, sizeBoxY, editBoxWidth, buttonHeight, new TextComponent("Icon Size"));
