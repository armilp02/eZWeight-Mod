...
public class WeightMiniHudOverlay {
    ...
    private static final ResourceLocation ICON_YELLOW = ResourceLocation.fromNamespaceAndPath("ezweight", "textures/gui/weight_yellow.png");
    private static final ResourceLocation ICON_RED = ResourceLocation.fromNamespaceAndPath("ezweight", "textures/gui/weight_red.png");
