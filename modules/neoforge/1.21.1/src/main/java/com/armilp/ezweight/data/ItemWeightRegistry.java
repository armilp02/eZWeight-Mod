...
public class ItemWeightRegistry {
                        ...
                        try {
                            ...
                            if (value instanceof Map<?, ?> itemData) {
                                ...
                                if (itemData.containsKey("backpack_weight_reduction")) {
                                    ...
                                    double reduction = (reductionObj instanceof Number)
                                            ? ((Number) reductionObj).doubleValue()
                                            : 0.20;
                                ...
                                if (itemData.containsKey("backpack_max_weight")) {
                                    ...
                                    double maxWeight = (maxWeightObj instanceof Number)
                                            ? ((Number) maxWeightObj).doubleValue()
                                            : 250.0;
        ...
        try {
            ...
            for (Map.Entry<ResourceLocation, Double> entry : ITEM_WEIGHTS.entrySet()) {
                ...
                if (ammoWeight != null || backpackReduction != null || backpackMaxWeight != null) {
                    ...
                    if (backpackReduction != null) {
                        itemData.put("backpack_weight_reduction", backpackReduction);
                    }

                    if (backpackMaxWeight != null) {
                        itemData.put("backpack_max_weight", backpackMaxWeight);
                    }
        ...
        if (taczLoaded) {
            ...
            if (item instanceof AbstractGunItem) {
                if (tag != null && tag.contains("GunId", Tag.TAG_STRING)) {
                    try {
                        return ResourceLocation.parse(tag.getString("GunId"));
                    } catch (Exception e) {
                ...
                if (tag != null && tag.contains("AttachmentId", Tag.TAG_STRING)) {
                    try {
                        return ResourceLocation.parse(tag.getString("AttachmentId"));
                    } catch (Exception e) {
    ...
    public static double getStackTotalWeight(ItemStack stack) {
        ...
        if (taczLoaded && stack.getItem() instanceof AbstractGunItem) {
            return GunIdUtils.calculateTotalWeight(stack) * stack.getCount();
        }
        ResourceLocation effectiveId = getEffectiveId(stack);
